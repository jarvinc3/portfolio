...
function Info() {
    ...
    return (
        <div className="">
            <h5 onClick={toggleDrawer} id="drawer-label" className="md:fixed md:top-3 md:left-3 absolute right-12 top-[25px] text-lg cursor-pointer inline-flex items-center mb-4 font-semibold text-gray-500 dark:text-gray-400">
