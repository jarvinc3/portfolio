...
export default function Header() {
  ...
  return (
    <div id='inicio' className='header h-screen'>
      ...
      <h1 className='md:text-[100px] text-6xl gradient-text'>Jarvin</h1>
      <h1 className='md:text-[110px] text-7xl gradient-text'>Collado</h1>
      <div className="div">
        <p>
          Full-stack web developer. Passionate about learning.
        </p>
      </div>
